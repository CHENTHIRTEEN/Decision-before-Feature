...
## 3.2 ELA Utility 与 Offline Oracle
...
| `Decision-before-Feature_ELA Utility Oracle构建协议.md`                | [R3], [R5], [R8]–[R11], [R29]         | 共享前缀 Oracle、标签聚合                      |
...
| `Decision-before-Feature Algorithm Portfolio与Selection Oracle设计.md` | [R1], [R4], [R5], [R24]–[R28]         | 四算法组合和现实 selector                      |
